...
public class DataBaseForDict extends SQLiteOpenHelper {
    ...
    public DataBaseForDict(Context context) {
    ...
    public DataBaseForDict(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version, Context mContext) {
    ...
    public ArrayList<Word> searchWord(String text) {
